...
def invoke_fused_moe_kernel(
    ...
    padded_size = 0
    assert not use_fp8_w8a8 and not use_int8_w8a8 and not use_int8_w8a16 and not use_int4_w4a16
...
def fused_experts(
    ...
    if inplace:
        ...
        torch.ops.gllm.inplace_fused_experts(
            hidden_states,
            w1,
            w2,
            topk_weights,
        ...
        return torch.ops.gllm.outplace_fused_experts(
            hidden_states,
            w1,
            w2,
            topk_weights,
