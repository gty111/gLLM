...
def main(args: argparse.Namespace):
    ...
    if args.backend == "vllm":
        ...
        elapsed_time = run_gllm(
            requests, args.model, args.gpu_memory_utilization, args.kvthresh
        )
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--backend", type=str, choices=["vllm", "hf", "mii", "gllm"], default="vllm"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=256,
        help="maximum number of seqs per " "iteration",
    )
    parser.add_argument(
        "--download-dir",
        type=str,
